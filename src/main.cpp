...
const string strMessageMagic = "Honorcoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    {
        nSubsidy = 21000000 * COIN; // Honorcoin Swap-Block
    }
		else if(pindexBest->nHeight < 720)
    {
		nSubsidy = 0 * COIN; // No Reward to Prevent Instamine/Fair Exchange
    }
		else if(pindexBest->nHeight < 525000)
    {
		nSubsidy = 40 * COIN;
    }
		else if(pindexBest->nHeight < 525500) // To make sure PoS starts
	{
		nSubsidy = 0 * COIN;
	}
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Honorcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Honorcoin Project Restored 7/20/2014";
        CTransaction txNew;
        txNew.nTime = 1405988100;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x01d8c5c7f12ba3d2626f1b2cc86004ce73af131348d9187c2c38a1c5f7e17405"));
        block.print();

...
void StatisticsPage::updateStatistics()
{
    ...
    QString phase = "";
    if (pindexBest->nHeight < 525000)
    {
        phase = "X13 POW";
    }
    else if (pindexBest->nHeight > 525000)
    {
        phase = "POS - 5% Interest";
    }
    ...
    {
        ui->volumeBox->setText("<b><font color=\"green\">" + qVolume + " XHC" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " XHC" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " XHC");
    }
